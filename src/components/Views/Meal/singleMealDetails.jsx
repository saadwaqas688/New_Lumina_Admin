...
const SingleMealDetails = ({data}) => {
  ...
  <Grid container   spacing={2} sx={{padding:'10px'}}>
    ...
    <Box sx={{display:"flex",justifyContent:"center",mt:'20px'}}> 
       <Typography variant="h5" color="text.secondary"  sx={{borderBottom:'lightgrey 3px solid',mt:'20px'}}>
  ...
  />
        ...
        <Box sx={{display:'flex',flexDirection:'column' ,justifyContent:'center',alignItems:'center',marginRight:'20px'}}>
         <Typography variant="h5" color="text.secondary" sx={{mt:'20px',ml:'20px',mr:'20px',fontWeight:'bold',borderBottom:'lightgrey 3px solid'}}>
           Calories
          </Typography>
         ...
         Carbs
          ...
          <Typography variant="h5" color="text.secondary" sx={{fontWeight:'bold',borderBottom:'lightgrey 3px solid'}}>
          Ingredients 
          </Typography>
          </Box>
       ...
       {   data.ingredients.map((item,index)=>{
         ...
         { <Grid item xs={12}>
          ...
          {item.quantity}
                 ...
                 <Box sx={{display:"flex",justifyContent:"center",mb:'20px',mt:'20px'}}>     
    <Typography variant="h5" color="text.secondary" sx={{mt:'20px',textAlign:'center',fontWeight:'bold',borderBottom:'lightgrey 3px solid'}}>
         Recipe 
        </Typography>
        </Box>
